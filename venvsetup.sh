#!/usr/bin/env bash
# -*- mode: shell-script; encoding: utf-8 -*-

# ========================================================================
# Copyright (c) 2017 Matt Bogosian <mtb19@columbia.edu>.
#
...
_venvsetup() {
    (
        ...
        "${_VENVSETUP_PIP}" install debug flake8 jedi pyflakes pylint tox virtualenv
